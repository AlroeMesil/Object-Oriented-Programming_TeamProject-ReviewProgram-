...
public class indiviBoard {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(() -> {
            try {
                ...
                indiviBoard window = new indiviBoard(mgr.postList, postNum, mgr, userId, mgr.commentList);
    ...
    public indiviBoard(ArrayList<Manageable> postList, int postNum, Manager mgr, String userId, ArrayList<Manageable> commentList) {
        for (Manageable post : postList) {
            if (post instanceof Post && ((Post) post).getPostNum() == postNum) {
                Post selectedPost = (Post) post;
                initialize((Post) post, mgr, userId, commentList);
                return;
            }
        }
    ...
    private void initialize(Post post, Manager mgr, String userId, ArrayList<Manageable> commentList) {
        frame = new JFrame();
